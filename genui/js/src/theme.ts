...
// <style id="genui-tokens">:root{ … }</style> block into the frame's own
// <head> from params.tokens (a {"--name":"value"} map). Because this <style>
// is appended AFTER genui.css, it wins on equal :root specificity — and
// genui.css declares its whole default palette on :root up front
