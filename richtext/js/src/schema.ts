...
// (`schemaVersion = "richtext-v1"`). This file is the anti-drift contract shared
...
// `var(--richtext-fg-<slot>)` / `var(--richtext-bg-<slot>)` — NEVER raw hex.

import { Schema, type NodeSpec, type MarkSpec, type Node as PMNode } from "prosemirror-model";
import { tableNodes } from "prosemirror-tables";

export const SCHEMA_VERSION = "richtext-v1";
...
const divider: NodeSpec = {
  ...
  parseDOM: [{ tag: "hr" }],
  toDOM() {
    return ["hr", { class: "richtext-divider" }];
  },
};
...
const task_list: NodeSpec = {
  ...
  content: "task_item+",
  defining: true,
  parseDOM: [{ tag: "ul[data-type='richtext-task']" }],
  toDOM() {
    return ["ul", { "data-type": "richtext-task", class: "richtext-task-list" }, 0];
  },
};
...
const task_item: NodeSpec = {
  ...
  parseDOM: [
    {
      tag: "li[data-type='richtext-task-item']",
  ...
  toDOM(node) {
    return [
      "li",
      {
        "data-type": "richtext-task-item",
        "data-checked": node.attrs.checked ? "true" : "false",
        class: "richtext-task-item" + (node.attrs.checked ? " is-checked" : ""),
      },
      [
        "span",
        {
          class: "richtext-task-checkbox",
      ...
      ["div", { class: "richtext-task-content" }, 0],
    ];
  },
};
...
const callout: NodeSpec = {
  ...
  toDOM(node) {
    return [
      "div",
      {
        class: `richtext-callout richtext-callout-${calloutVariant(node.attrs.variant)}`,
        [CALLOUT_ATTR]: calloutVariant(node.attrs.variant),
        "data-icon": node.attrs.icon || undefined,
      },
      ["div", { class: "richtext-callout-body" }, 0],
    ];
  },
};
...
const toggle: NodeSpec = {
  ...
  parseDOM: [
    {
      tag: "div[data-type='richtext-toggle']",
  ...
  toDOM(node) {
    return [
      "div",
      {
        "data-type": "richtext-toggle",
        "data-open": node.attrs.open ? "true" : "false",
        class: "richtext-toggle" + (node.attrs.open ? " is-open" : ""),
      },
      0,
    ];
  },
...
const toggle_summary: NodeSpec = {
  content: "inline*",
  defining: true,
  parseDOM: [{ tag: "div[data-type='richtext-toggle-summary']" }],
  toDOM() {
    return [
      "div",
      {
        "data-type": "richtext-toggle-summary",
        class: "richtext-toggle-summary",
        contenteditable: "true",
      },
      ["span", { class: "richtext-toggle-icon", contenteditable: "false", "aria-hidden": "true" }],
      ...
      ["span", { class: "richtext-toggle-summary-text" }, 0],
    ];
  },
};
...
const content: NodeSpec = {
  content: "block+",
  defining: true,
  parseDOM: [{ tag: "div[data-type='richtext-toggle-content']" }],
  toDOM() {
    return ["div", { "data-type": "richtext-toggle-content", class: "richtext-toggle-content" }, 0];
  },
};
...
const columns: NodeSpec = {
  ...
  parseDOM: [
    {
      tag: "div[data-type='richtext-columns']",
  ...
  toDOM(node) {
    return [
      "div",
      {
        "data-type": "richtext-columns",
        "data-count": node.attrs.count,
        class: `richtext-columns richtext-columns-${node.attrs.count}`,
      },
      0,
    ];
  },
...
const column: NodeSpec = {
  ...
  isolating: true,
  defining: true,
  parseDOM: [{ tag: "div[data-type='richtext-column']" }],
  toDOM() {
    return ["div", { "data-type": "richtext-column", class: "richtext-column" }, 0];
  },
};
...
const code: MarkSpec = {
  parseDOM: [{ tag: "code" }],
  toDOM() {
    return ["code", { class: "richtext-code" }, 0];
  },
...
// textColor — token ref `var(--richtext-fg-<slot>)` (schema §3). Stored slot name.
const textColor: MarkSpec = {
  attrs: { color: { default: "default", validate: "string" } },
  inclusive: false,
  parseDOM: [
    {
      tag: "span[data-richtext-color]",
      getAttrs: (dom) => ({ color: dom.getAttribute("data-richtext-color") || "default" }),
    },
    {
      style: "color",
      getAttrs: (value) => {
        const m = /var\(--richtext-fg-([a-z]+)\)/.exec(String(value || ""));
  ...
  toDOM(node) {
    ...
    return [
      "span",
      {
        "data-richtext-color": slot,
        class: `richtext-fg-${slot}`,
        style: `color: var(${colorStyleVar("--richtext-fg", slot)})`,
      },
      0,
    ];
  },
...
// bgColor — highlight; token ref `var(--richtext-bg-<slot>)`.
const bgColor: MarkSpec = {
  attrs: { color: { default: "default", validate: "string" } },
  inclusive: false,
  parseDOM: [
    {
      tag: "span[data-richtext-bg]",
      getAttrs: (dom) => ({ color: dom.getAttribute("data-richtext-bg") || "default" }),
    },
    {
      style: "background-color",
      getAttrs: (value) => {
        const m = /var\(--richtext-bg-([a-z]+)\)/.exec(String(value || ""));
        return m ? { color: m[1] } : false;
      },
    },
  ],
  toDOM(node) {
    ...
    return [
      "span",
      {
        "data-richtext-bg": slot,
        class: `richtext-bg-${slot}`,
        ...
        // mode failed the dogfood contrast check). --richtext-bg-ink lets a
        // host theme override it.
        style: `background-color: var(${colorStyleVar("--richtext-bg", slot)}); color: var(--richtext-bg-ink, #1b1f24)`,
      },
      0,
    ];
  },
