...
func TestRenderFullDoc(t *testing.T) {
	...
	mustContain(t, out, `data-fui-comp="richtext-read"`)
	...
	mustContain(t, out, `<pre><code class="language-go"><span class="hl-keyword">func</span> <span class="hl-function">main</span>() {}</code></pre>`)
	mustContain(t, out, "<hr")
	mustContain(t, out, "<ul>", "<li>one</li>")
	mustContain(t, out, `<ol start="3">`)
	mustContain(t, out, `class="richtext-task-list"`)
	mustContain(t, out, `aria-checked="true" checked="" disabled="" type="checkbox"`)
	mustContain(t, out, `class="richtext-callout richtext-callout--warn" data-variant="warn"`)
	mustContain(t, out, `<details class="richtext-toggle" open="">`)
	mustContain(t, out, "<summary ", "summary line", "body")
	mustContain(t, out, `class="richtext-columns" data-count="2"`)
	mustContain(t, out, `<img alt="pic" src="https://example.com/a.png" title="T" width="100">`)
	mustContain(t, out, `<table class="richtext-table">`)
...
func TestRenderColorSlots(t *testing.T) {
	...
	out := Render(d)
	mustContain(t, out, `style="color:var(--richtext-fg-blue,var(--color-primary))"`)
	...
	mustContain(t, out, `style="background-color:var(--richtext-bg-yellow,var(--color-warning));color:var(--richtext-bg-ink,#1b1f24)"`)
	// Invalid slot (raw hex) is dropped — text kept, no style attribute.
	mustContain(t, out, "bad")
	mustNotContain(t, out, "#ff0000")
	mustNotContain(t, out, "--richtext-fg-#")
}
...
func TestRenderEmptyDoc(t *testing.T) {
	...
	mustContain(t, out, `class="richtext-read"`)
...
func TestRenderCalloutDefaultVariant(t *testing.T) {
	...
	out := Render(d)
	mustContain(t, out, "richtext-callout--info")
