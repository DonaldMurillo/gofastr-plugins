// Package ssr renders canonical Rich Text block-JSON (a ProseMirror doc, schema
// version "richtext-v1") into design-token HTML for the no-JS first paint.
//
...
//
//   - a registered stylesheet (core-ui/registry "richtext-read") supplies every
...
// auto-loads via the registered "richtext-read" marker, no manual <link>:
//
