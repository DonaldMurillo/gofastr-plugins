...
// <style id="whiteboard-tokens">:root{ … }</style> block into the frame's own
// <head> from params.tokens (a {"--name":"value"} map). Because this <style>
// is appended AFTER board.css, it wins on equal :root specificity. The frame
...
const STYLE_ID = "whiteboard-tokens";
