// ProseMirror plugin assembly for the WYSIWYG editor (schema wysiwyg-v1).
//
...
// via a decoration (the .wysiwyg-placeholder CSS already exists). Purely visual;
